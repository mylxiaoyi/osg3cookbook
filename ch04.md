...
![image](_images/osgcookbook_4.1.png)
...
![image](_images/osgcookbook_4.2.png)

为了在每一个辅助相机中正确渲染场景，我们可以保持视图矩阵，并重新设置辅助截面的参数。

投影矩阵可以写为下列样子：

![image](_images/osgcookbook_4.3.png)
...
![image](_images/osgcookbook_4.4.png)
...
![image](_images/osgcookbook_4.7.png)
...
![image](_images/osgcookbook_4.8.png)
...
![image](_images/osgcookbook_4.9.png)
...
![image](_images/osgcookbook_4.10.png)
...
![image](_images/osgcookbook_4.11.png)
...
![image](_images/osgcookbook_4.12.png)
